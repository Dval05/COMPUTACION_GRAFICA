...
namespace P2Act25Nov
{
    public partial class frmCircunferencias : Form
    {
        ...
        private async void btnDibujar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Por favor, ingrese un valor para el radio.", "Error de Validación", 
            ...
            {
                MessageBox.Show("El radio debe ser un número entero válido.\nNo se permiten letras ni caracteres especiales.", 
